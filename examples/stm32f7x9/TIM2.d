...
*/
final abstract class TIM2 : Peripheral!(0x40000000)
{
    /*************************************************************************
     control register 1
    */
    ...
    */
    final abstract class OR1 : Register!(0x50)
    {
        /*********************************************************************
         Input Capture 4 remap
        */
        alias TI4_RMP = BitField!(3, 2, Mutability.rw);

        /*********************************************************************
         External trigger remap
        */
        alias ETR1_RMP = Bit!(1, Mutability.rw);

        /*********************************************************************
         Internal trigger 1 remap
        */
        alias ITR1_RMP = Bit!(0, Mutability.rw);
    }

    /*************************************************************************
     TIM2 option register 2
    */
    final abstract class OR2 : Register!(0x60)
    {
        /*********************************************************************
         ETR source selection
        */
        alias ETRSEL = BitField!(16, 14, Mutability.rw);
    }
}
