...
final abstract class ADC : Peripheral!(0x42004000)
{
    ...
    */
    final abstract class AVGCTRL : Register!(0x2)
    {
        ...
        */
        alias SAMPLENUM = BitField!(3, 0, Mutability.rw, SAMPLENUMValues);
    ...
    */
    final abstract class CTRLB : Register!(0x4)
    {
        ...
        */
        alias RESSEL = BitField!(5, 4, Mutability.rw, RESSELValues);
    ...
    */
    final abstract class INPUTCTRL : Register!(0x10)
    {
        ...
        */
        alias MUXPOS = BitField!(4, 0, Mutability.rw, MUXPOSValues);
        ...
        */
        alias MUXNEG = BitField!(12, 8, Mutability.rw, MUXNEGValues);
        ...
        */
        alias GAIN = BitField!(27, 24, Mutability.rw, GAINValues);
    }
